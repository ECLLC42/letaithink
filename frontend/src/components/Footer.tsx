...
const Footer: React.FC = () => {
  ...
  const socialLinks = [
    { platform: 'twitter', href: 'https://twitter.com/letaithink', icon: '𝕏' },
    { platform: 'linkedin', href: 'https://linkedin.com/company/letaithink', icon: 'in' },
    { platform: 'github', href: 'https://github.com/letaithink', icon: '⌥' },
    { platform: 'discord', href: 'https://discord.gg/letaithink', icon: '◊' }
  ];
